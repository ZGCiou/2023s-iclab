...
reg [3:0] count_out;
reg [inst_sig_width+inst_exp_width:0] p1Reg_xu, p1Reg_wh, p2Reg, p3Reg, p5Reg, p6Reg, p7Reg, p8Reg, acc_uxwh, acc_vy[0:2];//, cal_H[0:2];
reg [4:0] p1Reg_flag, p2Reg_flag, p3Reg_flag;
reg [3:0] p4Reg_flag;
reg [2:0] p5Reg_flag;
reg p6Reg_flag, p7Reg_flag, p8Reg_flag;
...
// Stage 7
// Sigmoid -> exp
assign exp_vh_in = {~p6Reg[inst_sig_width+inst_exp_width], p6Reg[inst_sig_width+inst_exp_width-1:0]};
...
// Sigmoid -> add
DW_fp_add #(inst_sig_width, inst_exp_width, inst_ieee_compliance)
	Add_exp(.a(p7Reg), .b(32'h3F800000), .rnd(3'b000), .z(add_exp_out));
// Pipeline Reg 7
...
DW_fp_div #(inst_sig_width, inst_exp_width, inst_ieee_compliance, faithful_round)
	D0(.a(32'h3F800000), .b(p8Reg), .rnd(3'b000), .z(div_out));
// Pipeline Reg 9(out_Y)
